...
moodle_course_text = "Select the dataset portion"
...
select_period_text = "Select the observation period"
...
study_session_identification_text = "Select the study session identification method"
...
check_list_options = [{"label": "Group tasks", "value": "grouped"},
                      {"label": "Exclude only-attendance sessions", "value": "del_only_attendance"}]
...
suggestion_threshold = "Behaviour fluctuations between {} and {} minutes (granularity 1 minute). Recommended threshold: {} minutes"
no_breaks_caused_text = "This module did not cause any of the pauses"
